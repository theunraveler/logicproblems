...
<template>
    <BFormInput v-model="formulaText" ref="input" placeholder="Formula" :state="error.length <= 0" required />
    ...
    <BFormInvalidFeedback :state="error.length <= 0">{{ error }}</BFormInvalidFeedback>
</template>
