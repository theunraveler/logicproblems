...
onBeforeRouteUpdate(async () => {
    return !proofTable?.value?.hasUnsavedChanges || window.confirm(
...
<template>
    ...
    <BModal :show="proofTable?.proof?.qed()" title="Q.E.D." ok-only ok-title="Close">Congrats, you solved the problem!</BModal>
</template>
