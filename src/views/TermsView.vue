<template>
  ...
  <ol type="a">
    <li>
      ...
      software) on Logic Problems's web site for personal, non-commercial transitory viewing only.
      ...
      <ol type="i">
        ...
        <li>
          attempt to decompile or reverse engineer any software contained on Logic Problems's web
          site;
        </li>
    ...
    <li>
      ...
      terminated by Logic Problems at any time. Upon terminating your viewing of these materials or
  ...
  <ol type="a">
    <li>
      The materials on Logic Problems's web site are provided "as is". Logic Problems makes no
      ...
      rights. Further, Logic Problems does not warrant or make any representations concerning the
  ...
  <p>
    In no event shall Logic Problems or its suppliers be liable for any damages (including, without
    limitation, damages for loss of data or profit, or due to business interruption,) arising out of
    the use or inability to use the materials on Logic Problems's Internet site, even if Logic
    Problems or a Logic Problems authorized representative has been notified orally or in writing of
  ...
  <p>
    The materials appearing on Logic Problems's web site could include technical, typographical, or
    photographic errors. Logic Problems does not warrant that any of the materials on its web site
    are accurate, complete, or current. Logic Problems may make changes to the materials contained
    on its web site at any time without notice. Logic Problems does not, however, make any
  ...
  <p>
    Logic Problems has not reviewed all of the sites linked to its Internet web site and is not
    responsible for the contents of any such linked site. The inclusion of any link does not imply
    endorsement by Logic Problems of the site. Use of any such linked web site is at the user's own
    risk.
  </p>
  ...
  <p>
    Logic Problems may revise these terms of use for its web site at any time without notice. By
  ...
  <p>
    Any claim relating to Logic Problems's web site shall be governed by the laws of the State of
    Minnesota without regard to its conflict of law provisions.
  </p>
